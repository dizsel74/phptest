      ...
      <?php
        ...
        while($row=$result->fetch_assoc()){
          ...
          <tr>
            ...
            <a class='btn btn-success' href='#' onclick='showEditForm($row[id], \"$row[item]\", $row[item_type])'>Edit</a>
...
<script>
  function showEditForm(id, item, item_type) {
